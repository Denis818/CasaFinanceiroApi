...
{
    public class MembroConsultaServices(
        IDashboardConsultaServices _dashboardConsultaServices,
        IServiceProvider service) : BaseAppService<Membro, IMembroRepository>(service), IMembroConsultaServices
    {
