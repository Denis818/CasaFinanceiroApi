...
{
    public class GrupoFaturaComandoService(
        IServiceProvider service,
        IStatusFaturaRepository _statusFaturaRepository
    ) : BaseAppService<GrupoFatura, IGrupoFaturaRepository>(service), IGrupoFaturaComandoService
    {
        ...
        private string FormatNomeGrupo(GrupoFaturaDto grupoDto)
        {
